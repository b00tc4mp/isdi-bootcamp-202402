...
(function () {
    ...
    try { //Intento de Recuperar Usuario y Actualizar Interfaz
        var user = logic.retrieveUser() //Intenta recuperar el usuario utilizando la función retrieveUser con el nombre de usuario almacenado en la sesión
    ...
    logoutButton.addEventListener('click', function(){ //Evento de Cierre de Sesión
        logic.logoutUser() //se borra la información de la sesión actual (nombre de usuario)
    ...
    postButton.addEventListener('click', function (event) {
        ...
        var addImage = document.getElementById('img').value
        var addPost = document.getElementById('txt').value

        logic.createPost(addImage, addPost)
