...
function loginUser (username, password){
    ...
    const user = data.users.findOne(user => user.username === username && user.password === password
    )
...
function retrieveUser (){
    const user = data.users.findOne(user => user.id === sessionStorage.userId)
...
function retrievePosts(){
    ...
    posts.forEach(function (post) {
        const user = data.users.findOne(user => user.id === post.author)
...
function addMessageToChat (message, chatId){
    const chat = data.chats.findOne(chat => chatId === chat.id)
