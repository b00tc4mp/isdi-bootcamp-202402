...
matcha.describe('Arroz', function () {
    ...
    matcha.describe('> reduce', function () {
        ...
        matcha.it('should return a result of running the reducer across all elements of the array in a single value, this case starting with a initialValue', function () {
            var a = new Arroz(1, 2, 3, 4, 5);

            matcha.expect(!!a.reduce).toBe(true);
            matcha.expect(a).toBeInstanceOf(Arroz);

            var result = a.reduce(function (accumulator, currentValue) { return accumulator + currentValue });
