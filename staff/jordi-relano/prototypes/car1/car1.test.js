var Car = require('./car1')

console.log('TEST Car')

console.log('CASE constructor')

var car = new Car('Pagani', 'Huayra', 'on', 0, 2012, 'white', 3, 'gasoline', 'automatic', 7, 100, 'forward')

console.assert(car.brand === 'Pagani', 'brand is Pagani')
console.assert(car.model === 'Huayra', 'model is Huayra')
console.assert(car.status === 'off', 'is off')
console.assert(car.deposit === 0, 'deposit is 0')
console.assert(car.year === 2012, 'year is 2012')
...
console.assert(car.transmission === 'automatic', 'transmission is automatic')
