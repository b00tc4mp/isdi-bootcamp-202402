...
class CreatePost extends Component {
    constructor() {
        super('section') // crides al constructor de la super clase (component), asignes al tagName com a section. Crides al component amb el parametre section a tagname
